...
const directoryPath = path.join(__dirname, '/filesList'); // Cambia 'filesList' con il percorso della tua directory

// Esegui la funzione e esporta i file
getMp3Files(directoryPath)
  .then(mp3Files => {
    module.exports.array = mp3Files;
    console.log('File MP3 trovati e esportati:', mp3Files);
  })
  .catch(err => {
    console.error('Errore nella lettura della directory:', err);
  });
